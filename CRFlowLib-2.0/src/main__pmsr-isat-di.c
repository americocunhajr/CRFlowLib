...
/*
* -----------------------------------------------------------------
*  Pairwise Mixing Stirred Reaction ISAT --- pmsr_isat.c
*  Version: 1.6180
*  Date: Dec 15, 2010
* ----------------------------------------------------------------- 
...
int main(void)
{
    ...
    unsigned int Npair;      /* particles to pairwise        */
    ...
    file1 = fopen("pmsr-isat-di_mean_vs_t.dat","w");
    file2 = fopen("pmsr-isat-di_var_vs_t.dat","w");
    file3 = fopen("pmsr-isat-di_output_vs_t.dat","w");
    file4 = fopen("pmsr-isat-di_phi_vs_index.dat","w");
    ...
    while ( k < K && flag == GSL_SUCCESS )
    {
        ...
        for ( i = 0; i < Np && flag == GSL_SUCCESS; i++ )
        {
            ...
            flag = isat4(isat,thrm,cvode_mem_isat,etol,
